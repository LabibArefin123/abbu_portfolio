...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->call([
            ...
            // ProjectASeeder::class,
            // ProjectBSeeder::class,
            // ProjectCSeeder::class,
            // ProjectDSeeder::class,
            // ProjectESeeder::class,
            // ProjectFSeeder::class,
            // ProjectGSeeder::class,
            // ProjectHSeeder::class,
            // ProjectISeeder::class,
            // ProjectJSeeder::class,
            // ProjectKSeeder::class,
